...
- [x] [**Paw**](https://paw.cloud/)，请求模拟，前后端联调时用这个先走一遍
...
- [x] [**ColorSnapper2**](https://colorsnapper.com/)，取色工具
- [x] [**Charles**](https://www.charlesproxy.com/)，抓包用，支持 https, 不免费，公司提供。
...
- [x] [**Gif Brewery 3**](https://apps.apple.com/cn/app/gif-brewery-3-video-to-gif/id1081413713?l=en&mt=12) ，GIF 录屏工具
...
- [x] [**RDM**](https://github.com/avibrazil/RDM)，分辨率切换，允许设置未支持的分辨率，比如我会在录屏时设置 720p(hd) 的分辨率
- [x] [**KeyCastr**](https://github.com/keycastr/keycastr)，你在键盘上按了哪些键，会显示在屏幕上，适合录屏的时候使用。通过 homebrew cask 安装: `brew cask install keycastr`。记得mac设置Security & Privacy下的Input monitoring 和 Accessibility里面要加上并勾选。顺便把开始显示键盘的快捷键设置成了F19 + k。

### 其他

- [x] [**CleanMyMac 3**](https://macpaw.com/cleanmymac)，系统清理
...
<!-- - [ ] [**Bartender 3**](https://www.macbartender.com/)，管理系统右上菜单项，隐藏或收起不常用的，收费。 -->
<!-- - [ ] [**KeepingYouAwake**](https://github.com/newmarcel/KeepingYouAwake)，可保证系统不自动休眠 -->
- [x] [**KeepingYo,iuAwake**](https://github.com/newmarcel/KeepingYouAwake)，可保证Mac系统不自动休眠。原来用的[Caffeine](http://lightheadsw.com/caffeine/)，但是[MacOS更新到Mojave以后就不管用了](https://www.reddit.com/r/osx/comments/9pbl9u/macos_mojave_caffeine_replacement/)。可以改用Amphetamine 或者 KeepingYouAwake。
<!-- - [ ] [**Softorino YouTube Converter**](https://softorino.com/youtube-converter)，免费24小时，之后收费，YouTube 视频下载 -->
...
<!-- - [ ] [**Downie 3**](http://software.charliemonroe.net/downie.php)，通用视频下载，收费，SetApp含有 -->
...
- [x] [**IINA**](https://github.com/iina/iina)，[IINA](https://iina.io/)视频播放。原来用的[VLC media player](https://www.videolan.org/vlc/index.zh.html)，后来[改用IINA](https://www.zhihu.com/question/19552878/answer/139035466)。
...
- [x] [**钉钉**](https://tms.dingtalk.com/markets/dingtalk/download) + [**QQ**](https://im.qq.com/macqq/) + [**微信**](https://mac.weixin.qq.com/) + [**Slack**](https://slack.com/downloads/mac)，通讯交流。App store 有，免费。
- [ ] [**Tuxera NTFS**](https://www.tuxera.com/products/tuxera-ntfs-for-mac/) - 支持 NTFS 格式硬盘，收费。
...
- [x] [**Oreilly Safari Books**](https://www.safaribooksonline.com/)，Oreilly 图书、视频教程、newsletter 等。公司报销，很划算，等于我没掏钱。
